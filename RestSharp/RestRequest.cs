...
namespace RestSharp
{
    ...
    public class RestRequest : IRestRequest
    {
        ...
        /// <param name="method">Method to use for this request</param>
        public RestRequest(string resource, Method method = Method.GET) : this(resource, method, DataFormat.Xml)
        {
        }
        ...
        public RestRequest(Uri resource, Method method, DataFormat dataFormat = DataFormat.Xml)
